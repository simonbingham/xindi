<cfoutput>
	...
	<div class="btn-group pull-right append-bottom" data-toggle="buttons-checkbox">
		...
		<cfif rc.User.getUserID() neq rc.CurrentUser.getUserID() and rc.User.isPersisted()><a href="#buildURL('users.delete')#/userid/#rc.User.getUserID()#" title="Delete" class="btn btn-danger"><i class="glyphicon glyphicon-trash glyphicon-white"></i> Delete</a></cfif>
	</div>
