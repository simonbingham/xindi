<cfoutput>
	...
	<div class="btn-group pull-right append-bottom" data-toggle="buttons-checkbox">
		...
		<cfif rc.Article.isPersisted()><a href="#buildURL('news.delete')#/articleid/#rc.Article.getArticleID()#" title="Delete" class="btn btn-danger"><i class="glyphicon glyphicon-trash glyphicon-white"></i> Delete</a></cfif>
	</div>
