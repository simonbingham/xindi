			...
			<tbody>
				<cfloop array="#rc.articles#" index="local.Article">
					<tr>
						...
						<td class="center"><cfif local.Article.isPublished()><a href="#buildURL(action='public:news.article', querystring='slug=#local.Article.getSlug()#')#" title="View" target="_blank"><i class="glyphicon glyphicon-eye-open"></i></a></cfif></td>
