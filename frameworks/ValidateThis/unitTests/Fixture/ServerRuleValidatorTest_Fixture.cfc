...
<cfcomponent output="false">
	...
	<cffunction name="init" access="public" returntype="any">
		...
		<cfargument name="customReturn" required="false" default="true" />
		<cfset variables.FirstName = arguments.FirstName />
		<cfset variables.LastName = arguments.LastName />
		<cfset variables.customReturn = arguments.customReturn />
		<cfreturn this />
	</cffunction>
	...
	<cffunction name="setLastName" access="public" returntype="any">
		<cfargument name="LastName" required="false" default="Bob" />
		<cfset variables.LastName = arguments.LastName />
		<cfreturn this />
	</cffunction>
	...
	<cffunction name="setCustomReturn" access="public" returntype="any">
		<cfargument name="customReturn" required="false" default="true" />
		<cfset variables.customReturn = arguments.customReturn />
		<cfreturn this />
	</cffunction>
	
	<cffunction name="customMethod" access="public" returntype="any">
		<cfset var returnVal = {IsSuccess=true,FailureMessage=""} />
		<cfif not variables.customReturn>
			<cfset returnVal = {IsSuccess=false,FailureMessage="No!"} />
		</cfif>
		<cfreturn returnVal />
	</cffunction>
