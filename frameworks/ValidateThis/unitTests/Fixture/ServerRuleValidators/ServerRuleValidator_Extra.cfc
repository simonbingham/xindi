...
--->
<cfcomponent output="false" extends="ValidateThis.server.AbstractServerRuleValidator" hint="I am a fixture for unit testing.">
	...
	<cffunction name="validate" returntype="any" access="public" output="false" hint="I perform the validation returning info in the validation object.">
		...
		<cfif NOT IsValid("Date",arguments.valObject.getObjectValue())>
