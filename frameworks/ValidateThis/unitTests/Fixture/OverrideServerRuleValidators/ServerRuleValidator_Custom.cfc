...
--->
<cfcomponent output="false" name="ServerRuleValidator_Custom" extends="ValidateThis.server.AbstractServerRuleValidator" hint="I am responsible for performing a custom validation.">
