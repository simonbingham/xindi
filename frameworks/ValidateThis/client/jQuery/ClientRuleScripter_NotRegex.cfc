...
--->
<cfcomponent output="false" name="ClientRuleScripter_notregex" extends="AbstractClientRuleScripter" hint="I am responsible for generating JS code for the not regex validation.">
