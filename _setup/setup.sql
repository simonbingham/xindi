...
-- Dumping structure for table xindi.articles
CREATE TABLE IF NOT EXISTS `articles` (
  `article_id` int(11) NOT NULL AUTO_INCREMENT,
  `article_uuid` varchar(150) DEFAULT NULL,
  `article_title` varchar(150) DEFAULT NULL,
  `article_content` longtext,
  `article_metatitle` varchar(200) DEFAULT NULL,
  `article_metadescription` varchar(200) DEFAULT NULL,
  `article_metakeywords` varchar(200) DEFAULT NULL,
...
-- Dumping data for table xindi.articles: ~1 rows (approximately)
...
-- Dumping data for table xindi.users: ~1 rows (approximately)
